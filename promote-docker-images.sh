...
# usage:
#     ./promote-docker-images.sh vault-auth-plugin-example 0.7.0 --latest
...
# Check if $STAGING_REGISTRY has the staged images and ensure we will promote the correct staged images
